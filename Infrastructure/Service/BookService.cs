...
namespace Infrastructure.Service
{
    public class BookService : IBookService
    {
        ...
        {
            return _mapper.Map<IEnumerable<BookDto>>(await _repository.GetAllAsync());
        }
        ...
        public async Task<BookDto> GetBooksByISBN(string isbn)
        {
            ...
            return _mapper.Map<BookDto>((await _repository.GetAllWitAllIncludeAsync(x=>x.ISBN==isbn)).OrderBy(x=>x.PageCount));
